# -*- coding: utf-8 -*-
"""美股细分行业板块龙头股 Yahoo Finance 1h 回测：2025全年 + 2026至今

板块：存储 / 光通信(CPO) / AI芯片 / 半导体 / 云计算 / 数据中心 / 航天 / 卫星通信。
...
# 22 只细分行业板块龙头股（SK海力士为韩国KOSPI: 000660.KS，其余为美股）
TICKERS = ['WDC', 'STX', '000660.KS',
           'APH', 'NOK', 'AVGO', 'LITE',
           'TSM', 'ASML',
           'HPE', 'CRM',
           'EQIX', 'DLR', 'GDS',
           'HWM', 'RTX', 'NOC', 'LMT',
           'GILT', 'IRDM', 'ECHO', 'GSAT']
NAMES = {'WDC': '西部数据', 'STX': '希捷科技', '000660.KS': 'SK海力士',
         'APH': '安费诺', 'NOK': '诺基亚', 'AVGO': '博通', 'LITE': 'Lumentum',
         'TSM': '台积电', 'ASML': '阿斯麦',
         'HPE': '慧与', 'CRM': '赛富时',
         'EQIX': '易昆尼克斯', 'DLR': '数字房地产信托', 'GDS': '万国数据',
         'HWM': 'Howmet Aerospace', 'RTX': '雷神技术', 'NOC': '诺斯罗普·格鲁曼', 'LMT': '洛克希德马丁',
         'GILT': '吉来特卫星网络', 'IRDM': '铱星通讯', 'ECHO': '回声星通信', 'GSAT': '全球星'}
SECTORS = {'WDC': '存储', 'STX': '存储', '000660.KS': '存储',
...
with open('scripts/results/us_subsectors_yahoo_1h_2025.json', 'w', encoding='utf-8') as f:
    json.dump(all_results, f, ensure_ascii=False, indent=1, default=float)
print('\nsaved → scripts/results/us_subsectors_yahoo_1h_2025.json')
