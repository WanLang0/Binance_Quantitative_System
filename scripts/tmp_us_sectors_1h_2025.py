# -*- coding: utf-8 -*-
"""美股 11 大板块龙头股（Top 2）Yahoo Finance 1h 回测：2025全年 + 2026至今

与美股七姐妹同渠道：yfinance 拉美股 1h K线，覆盖 2025-01-01 ~ 今。
本脚本只测「尚未测试」的 16 只个股（七姐妹中的 AAPL/NVDA/GOOGL/META/AMZN/TSLA 此前已测）。
...
# 尚未测试的 16 只板块龙头股（七姐妹中的 6 只此前已入库，本轮跳过）
TICKERS = ['JPM', 'V', 'LLY', 'JNJ', 'BA', 'UPS', 'WMT', 'PG',
           'XOM', 'CVX', 'LIN', 'FCX', 'PLD', 'AMT', 'NEE', 'DUK']
NAMES = {'JPM': '摩根大通', 'V': 'Visa', 'LLY': '礼来', 'JNJ': '强生',
         'BA': '波音', 'UPS': '联合包裹', 'WMT': '沃尔玛', 'PG': '宝洁',
         'XOM': '埃克森美孚', 'CVX': '雪佛龙', 'LIN': '林德', 'FCX': '自由港麦克莫兰',
         'PLD': '安博', 'AMT': '美国电塔', 'NEE': '新纪元能源', 'DUK': '杜克能源'}
SECTORS = {'JPM': '金融', 'V': '金融', 'LLY': '医疗保健', 'JNJ': '医疗保健',
           'BA': '工业', 'UPS': '工业', 'WMT': '必需消费', 'PG': '必需消费',
           'XOM': '能源', 'CVX': '能源', 'LIN': '原材料', 'FCX': '原材料',
           'PLD': '房地产', 'AMT': '房地产', 'NEE': '公用事业', 'DUK': '公用事业'}
...
with open('scripts/results/us_sectors_yahoo_1h_2025.json', 'w', encoding='utf-8') as f:
    json.dump(all_results, f, ensure_ascii=False, indent=1, default=float)
print('\nsaved → scripts/results/us_sectors_yahoo_1h_2025.json')
